...
let Gadget = {
  name: 'Wriothesley Vinyl Player',
  batteryLife: '4 hours',
  isWireless: true,
}

function printGadgetSpecs(Gadget) {
  return `Name: ${Gadget.name} | Battery Life: ${Gadget.batteryLife} | Wireless: ${Gadget.isWireless}`// hint: use backticks and ${object.property} references.
}
...
let garden = {
  plants: ['Forget Me Not', 'Hibiscus', 'Lily of the Valley', 'Wriothesley', 'Spider Lily'],
